...
int main(int argc, char* argv[]) {
    ...
    // bench-layer doesn't need a prompt — it generates its own test input
    if (params.bench_layer) {
        // Load tokenizer and weight cache for bench-layer (needed for tensor lookup)
        Tokenizer tokenizer;
        ...
        // Setup working buffers (same as inference path)
