// BF16 variant of matmul_aie2p.mlir (hand-derived). The int8 path widens to i16
// for the MAC contract; bf16 is also 16-bit, so the packing/tiling is unchanged.
// Only the cast TYPES differ: contract inputs i16 -> bf16, accumulator i32 -> f32.
// Parameters: l1_m=64, l1_n=64, l2_k=64, pack=[8,8,8], accum=f32, contract_in=bf16
//
...
module attributes {transform.with_named_sequence} {
  transform.named_sequence @__transform_main(%arg1: !transform.any_op {transform.readonly}) {
    ...
    //==========================================================================
        ...
        // Cast accumulator (input[2]) and output[0] to f32 (bf16 MAC accumulates f32)
        ...
        // Cast vector.contract inputs 0,1 to bf16 (native MAC input type, 16-bit)
